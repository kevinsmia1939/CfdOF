...
$GMSH_EXE = "/tmp/.mount_FreeCAhpCCgg/usr/bin/gmsh"
$NTHREADS = (Get-CimInstance Win32_ComputerSystem).NumberOfLogicalProcessors
runCommand "$GMSH_EXE" -nt $NTHREADS - "gmsh/BooleanFragments_Geometry.geo"

runCommand gmshToFoam "gmsh/BooleanFragments_Geometry.msh"
